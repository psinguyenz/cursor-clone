                    ...
                    if (parentId && parentId !== "") {
                        try {
                            ...
                            if (parentFolder.type !== "folder") {
                                return `Error: Parent ID ${parentId} is a file, not a folder. Use a folder ID as parentId.`;
                            }
                        } catch (error) {
                            return `Error: Invalid parent ID ${parentId}. Use listFiles to get valid 
                            folder IDs, or use empty string for root level`;
                        }
                    }
