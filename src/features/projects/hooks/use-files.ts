...
export const useRenameFile = ({ projectId, parentId }: { projectId: Id<"projects">, parentId: Id<"files"> }) => {
    // Optimistic mutation (instantly update the UI)
...
export const useDeleteFile = ({ projectId, parentId }: { projectId: Id<"projects">, parentId: Id<"files"> }) => {
    // Optimistic mutation (instantly update the UI)
