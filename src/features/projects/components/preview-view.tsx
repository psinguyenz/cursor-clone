    ...
    return (
        <div className="h-full flex flex-col bg-background">
            ...
            <div className="h-8.75 flex items-center border-b bg-sidebar shrink-0">
                ...
                <div className="flex-1 h-full flex items-center px-3 bg-background border-x text-xs 
                    ...
                    {showTerminal && (
                        <Allotment.Pane minSize={100} maxSize={500} preferredSize={200}>
                            <div className="h-full flex flex-col bg-background border-t">
                                <div className="h-7 flex items-center px-3 text-xs gap-1.5 
